...
void telaInicial (void){//Tela Inicial do nosso jogo (ainda sem as opções de escolha)
	...
	file = fopen("C:\\Users\\Administrator\\Documents\\GitHub\\Geobuild\\Teste jogo\\assets\\Telas\\telaInicial.txt", "r");/*Função fopen
...
void telaPrincipal (void){// Tela principal do jogo contendo 1-Jogar 2-Creditos 3-Sair
	...
	FILE *file;
	file = fopen("C:\\Users\\Administrator\\Documents\\GitHub\\Geobuild\\Teste jogo\\assets\\Telas\\telaPrincipal.txt", "r");
...
void jogoInicio (void){
	...
	FILE *file;
	file = fopen("C:\\Users\\Administrator\\Documents\\GitHub\\Geobuild\\Teste jogo\\assets\\Telas\\jogoInicio.txt", "r");
